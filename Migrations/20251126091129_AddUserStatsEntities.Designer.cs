...
namespace Ilmanar.Migrations
{
    ...
    [Migration("20251126091129_AddUserStatsEntities")]
    partial class AddUserStatsEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ilmanar.Infra.Entities.UserLearningLogEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("UserLearningLogs");
                });

            modelBuilder.Entity("Ilmanar.Infra.Entities.UserProgressEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Ilmanar.Infra.Entities.UserProgressEntity", b =>
                {
                    b.HasOne("Ilmanar.Infra.Entities.SectionEntity", "Section")
                        .WithMany()
