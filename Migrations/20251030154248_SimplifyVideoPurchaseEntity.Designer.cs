...
namespace KitabStock.Migrations
{
    ...
    [Migration("20251030154248_SimplifyVideoPurchaseEntity")]
    partial class SimplifyVideoPurchaseEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KitabStock.Infra.Entities.VideoEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("KitabStock.Infra.Entities.VideoPurchaseEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("KitabStock.Infra.Entities.VideoPurchaseEntity", b =>
                {
                    b.HasOne("KitabStock.Infra.Entities.UserEntity", "User")
                        .WithMany("PurchasedVideos")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("KitabStock.Infra.Entities.VideoEntity", "Video")
                        .WithMany()
